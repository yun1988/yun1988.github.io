...
(function ($) {
    ...
    $.fn.dzsparallaxer = function (o) {
        ...
        this.each(function () {
            ...
            // Starting time and duration. Starting Target, Begin, Finish & Change ---
            // easing params
            ...
            var backup_duration_viy = 0
                ...
                function init() {
                    ...
                    if (cthis.find('.dzsparallaxer--blackoverlay').length > 0) {
                        _blackOverlay = cthis
                            .find('.dzsparallaxer--blackoverlay')
                            .eq(0);
                    }
                    if (cthis.find('.dzsparallaxer--fadeouttarget').length > 0) {
                        _fadeouttarget = cthis
                            .find('.dzsparallaxer--fadeouttarget')
                            .eq(0);
                    }
                    ...
                    // console.info(cthis,_theTarget, o); console.info(duration_viy);
                    ...
                    if (cthis.find('.dzsprxseparator--bigcurvedline').length > 0) {
                        cthis
                            ...
                            .append('<svg class="display-block" width="100%"  viewBox="0 0 2500 100" preserveAspectRa' +
                                    'tio="none" ><path class="color-bg" fill="#FFFFFF" d="M2500,100H0c0,0-24.414-1.02' +
                                    '9,0-6.411c112.872-24.882,2648.299-14.37,2522.026-76.495L2500,100z"/></svg>');
                    }

                    if (cthis.find('.dzsprxseparator--2triangles').length > 0) {
                        cthis
                            .find('.dzsprxseparator--2triangles')
                            .append('<svg class="display-block" width="100%"  viewBox="0 0 1500 100" preserveAspectRa' +
                                    'tio="none" ><polygon class="color-bg" fill="#FFFFFF" points="1500,100 0,100 0,0 ' +
                                    '750,100 1500,0 "/></svg>');
                    }
                    if (cthis.find('.dzsprxseparator--triangle').length > 0) {
                        cthis
                            .find('.dzsprxseparator--triangle')
                            .append('<svg class="display-block" width="100%"  viewBox="0 0 2200 100" preserveAspectRa' +
                                    'tio="none" ><polyline class="color-bg" fill="#FFFFFF" points="2200,100 0,100 0,0' +
                                    ' 2200,100 "/></svg>');
                    }
                    ...
                    if (cthis.get(0)) {
                        cthis
                            .get(0)
                            .api_set_scrollTop_is_another_element_top = function (arg) {
                    ...
                    if (cthis.find('.divimage').length > 0 || cthis.find('img').length > 0) {
                        var _loadTarget = cthis
                            .children('.divimage, img')
                            .eq(0);
                ...
                function init_start() {
                    ...
                    inter_recheck_dims = setInterval(function () {
                        handle_resize(null, {'call_from': 'autocheck'})
                    }, 2000);
                            ...
                            if (cthis.find('.divimage').length > 0) {
                                if (lazyloading_setsource) {
                                    cthis
                                        .find('.divimage')
                                        .eq(0)
                                        .css('background-image', 'url(' + lazyloading_setsource + ')');
                                }
                                ...
                                // console.info(cthis.find('.divimage').eq(0).css('background-image'),
                                // _loadTarget_src);
                    ...
                    cthis
                        .get(0)
                        .api_set_update_func = function (arg) {
                        api_outer_update_func = arg;
                    }
                    cthis
                        .get(0)
                        .api_handle_scroll = handle_scroll;
                    cthis
                        .get(0)
                        .api_destroy = destroy;
                    cthis
                        .get(0)
                        .api_destroy_listeners = destroy_listeners;
                ...
                function handle_resize(e, pargs) {
                    ...
                    // console.warn('handle_resize', last_wh, wh, st, last_cthis_ot, cthis_ot,
                    // margs);
                    last_wh = wh;
                    last_cthis_ot = cthis_ot;

                    // console.info(cthis_ot, cthis); console.warn(responsive_reference_width,
                    ...
                    if (o.js_breakout == 'on') {
                        ...
                        // console.info(cthis, cthis.get(0).offsetLeft, cthis.offset().left,
                        // _theTarget.offset().left)
                    ...
                    if (o.is_fullscreen == 'on') {
                        ...
                        // handle_scroll(null, {force_vi_y : vi_y});    setTimeout(function(){
                        // //console.info('WHAT', backup_duration_viy);        duration_viy =
                        // backup_duration_viy;    },50)    //console.info(target_viy,
                        // th-_theTarget.height()) }
                    }
                }
                ...
                function calculate_dims() {
                    ...
                    //return; console.info(initialheight);
                ...
                function handle_scroll(e, pargs) {
                    ...
                    // console.info(st,cthis_ot-cthis.outerHeight(), st,
                    // cthis_ot+cthis.outerHeight() );
                    ...
                    if (_scrollTop_is_another_element_top) {
                        ...
                        // console.info('handle_scroll', cthis, e, _scrollTop_is_another_element_top,
                        // _scrollTop_is_another_element_top.css('top'), st);
                    ...
                    // console.info('scroll top is - ',st, o.settings_listen_to_object_scroll_top,
                    // _scrollTop_is_another_element_top.css('top'),'target
                    // top->',_scrollTop_is_another_element_top.data('targettop'));
                    ...
                    if (e) {
                        if (o.init_functional_remove_delay_on_scroll == 'on') {
                            // console.info("REMOVE SUSPEND FUNCTIONAL !!! ", cthis, sw_suspend_functional,
                            // e);
                            sw_suspend_functional = false;
                        }
                    }
                    ...
                    //console.info('ch post force_ch',ch); console.info(margs);
                    ...
                    if (o.settings_mode == 'scroll') {
                        ...
                        // console.info('st and auxer5 - ',st, auxer5,
                        // o.settings_listen_to_object_scroll_top);
                                ...
                                if (cdata) {
                                    for (var j = 0; j < cdata.length; j++) {
                                        ...
                                        if (auxer5 <= 0.5) {
                                            ...
                                            //console.log(cval); console.info(cdata[j].property, auxval);
                        ...
                        // console.info(auxer5, ch,th); console.info('pre calculate vi_y', auxer5, ch,
                        // th);
                        ...
                        if (cthis.hasClass('simple-parallax')) {
                            ...
                            // console.info('scroll top - ',st); console.info('window height - ',wh);
                            // console.info('cthis offset top - ',cthis_ot); console.info('total height -
                            // ',th);
                        ...
                        // console.info(finish_viy); console.info('check ' , duration_viy);
                        ...
                        if (duration_viy === 0) {
                            ...
                            if (sw_suspend_functional == false || 0) {
                                // console.info('DURATION VIY = 0', st, vi_y, target_viy) if (is_ie() &&
                                // version_ie() <= 10) {     _theTarget.css('top', '' + target_viy + 'px'); }
                                // else {
                                //
                                //
                        ...
                        // clearTimeout(inter_suspend_enter_frame); if(sw_suspend_functional==false){
                        // inter_suspend_enter_frame = setTimeout(switch_suspend_enter_frame,700); }
                        // sw_suspend_functional = false;

                    }
                    var time = 0;
                    // console.info(vi_y); console.info(st/ch, vi_y); _theTarget.css('top',vi_y);
                    // _theTarget.css('transform','translate3d(0,'+vi_y+'px,0)');
                ...
                function handle_frame() {
                    ...
                    //console.info(finish_viy, begin_viy, change_viy); console.log(duration_viy);
                    if (o.easing == 'easeIn') {
                    ...
                    // console.log(begin_viy, change_viy, target_viy); console.info('DURATION VIY =
                    // many', duration_viy, vi_y, target_viy)
